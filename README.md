...
This is the code(most of it) for the Spotify App.
...
For you to see your data displayed in my spotify app, I would need to register you as a user, Spotify API only lets up to 25 users unfortunately.
